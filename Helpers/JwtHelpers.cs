...
{
    //取自保哥教學 https://blog.miniasp.com/post/2019/12/16/How-to-use-JWT-token-based-auth-in-aspnet-core-31)
    public class JwtHelpers
    {
        ...
        public string GenerateToken(User user, int expireMinutes = 30)
        {
            ...
            claims.Add(new Claim(JwtRegisteredClaimNames.Sub, user.Account)); // User.Identity.Name
            ...
            // 你可以自行擴充 "roles" 加入登入者該有的角色 Api Bearer token 時使用
